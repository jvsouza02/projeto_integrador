...
@section('content')
    <div class="container">
        ...
        <h2 class="mb-4 text-2xl font-bold">Pedidos @if (Route::currentRouteName() == 'garcom.pedidos_cliente') - {{ $reserva->cliente->usuario->name }} | {{ $reserva->mesa->numero }}  @endif</h2>
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            @if ($pedido->status == 'Em espera')
                                <form action="{{ route('cancelar_pedido', $pedido->idPedido) }}" method="GET"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
