            ...
            <tbody>
                @foreach ($dados as $pedido)
                    <tr>
                        ...
                        <td>{{ $pedido->status }}</td>
                        <td>
                            <button class='btn btn-success' data-toggle="modal" data-target="#alterarStatusModal{{ $pedido->idPedido }}">Alterar
                                Status</button>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="alterarStatusModal{{ $pedido->idPedido }}" tabindex="-1" role="dialog"
                        aria-labelledby="alterarStatusModalLabel{{ $pedido->idPedido }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="alterarStatusModalLabel{{ $pedido->idPedido }}">Alterar Status do Pedido</h5>
