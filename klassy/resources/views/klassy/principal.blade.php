                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>O Klassy Cafe é um dos melhores <a href="https://templatemo.com/tag/restaurant"
                                target="_blank" rel="sponsored">templates HTML para restaurantes</a> com o framework CSS
                            Bootstrap v4.5.2.
                        ...
                        <div class="col-lg-4"> <!-- Ajuste o número de colunas de acordo com o tamanho da tela -->
                            <div class="chef-item mt-2">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('storage/' . $funcionario->foto) }}" style="height: 250px; width: 250px; object-fit: cover;">
                                </div>
