...
<body>
            ...
            <form action="{{route('finalizar_pedido')}}" method="POST">
                ...
                <table class="table table-striped table-hover table-contextual">
                    ...
                    @foreach ($itens as $refeicao)
                        <tr>
                            <td><input type="text" name="nome[]" value="{{$refeicao->nome}}" class="border-0" readonly></td>
                            <td><input type="number" name="quantidade[]" value="{{$refeicao->quantidade}}" class="border-0"></td>
                            <td><input type="text" name="preco[]" value="{{$refeicao->preco}}" class="border-0" readonly></td>
                            <td><a href="{{route('remover_carrinho', $refeicao->id)}}"><i class="fa fa-trash text-2xl"></i></a></td>
                        </tr>
                    @endforeach
                </table>
    ...
    @else
        <div class="container mt-32 flex justify-center flex-col">
            <h1 class="text-center text-2xl font-bold">Seu carrinho esta vazio!</h1>
            <a href="{{route('home')}}" class="btn btn-dark w-52 mx-auto">Continuar Comprando</a>
        </div>
    @endif
